...
export default function FarmingBubble({ className, type }: FarmingBubbleProps) {
   const getImg = (type: string): string => {
      switch (type) {
         case 'iron':
            return '/enian.github.io/assets/original/resource/bubble-iron.svg';
         case 'leather':
            return '/enian.github.io/assets/original/resource/bubble-leather.svg';
         default:
            return '/enian.github.io/assets/original/resource/bubble-wood.svg';
      }
   };
